  ...
  <div>
    <Row>
      ...
      <Col sm={6} md={3}>
        ...
        <Field component={FormInput} name="section_1_company_name" label="Company Name"/>
        <Field component={FormInput} name="section_1_request_date" label="Request Date" type="date"/>
      </Col>
      <Col sm={6} md={3}>
        <Field component={FormInput} name="section_1_work_phone" label="Work Phone" type="tel"/>
        <Field component={FormInput} name="section_1_company_address" label="Company Address"/>
        <Field component={FormInput} name="section_1_supervisor_name" label="Supervisor Name"/>
      </Col>
      <Col sm={6} md={3}>
        <Field component={FormInput} name="section_1_cell_phone" label="Cell Phone" type="tel"/>
        <Field component={FormInput} name="section_1_division" label="Division"/>
        <Field component={FormInput} name="section_1_supervisor_phone" label="Supervisor Phone" type="tel"/>
      </Col>
      <Col sm={6} md={3}>
    ...
    <Row>
      ...
      <Col sm={6} md={4}>
        <Field component={FormSelect} name="section_2_reason" label="Reason" options={['Reason1', 'Reason2', 'Reason3']}/>
